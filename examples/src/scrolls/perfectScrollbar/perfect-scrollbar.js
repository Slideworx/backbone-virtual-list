    ...
    return this.each(function() {
      ...
      var bindMouseScrollYHandler = function() {
        ...
        $scrollbarY.bind('mousedown' + eventClassName, function(e) {
          ...
          /* hide all context menus, unless we're scrolling a context menu */
          if (!$(this).parent().parent().hasClass('ps-container')) {
            $(window).trigger('mousedown.contextmenu').trigger('areascroll');
          }
          /* */
      ...
      var bindMouseWheelHandler = function() {
        ...
        $this.bind('mousewheel' + eventClassName, function(e, deprecatedDelta, deprecatedDeltaX, deprecatedDeltaY) {
          ...
          if (!$(this).hasClass('ps-container')) {
            $(window).trigger('mousedown.contextmenu')
          }
          $(window).trigger('areascroll');
        ...
        $this.bind('MozMousePixelScroll' + eventClassName, function(e) {
          //console.log('ps-MozMousePixelScroll');
          if (shouldPrevent) {
            e.preventDefault();
          }
        });
      ...
      var bindKeyboardHandler = function() {
        ...
        $this.bind('mouseenter' + eventClassName, function(e) {
          //console.log('ps-mouseenter');
          hovered = true;
        });
        $this.bind('mouseleave' + eventClassName, function(e) {
          //console.log('ps-mouseleave');
          hovered = false;
        });

        var shouldPrevent = false; /*
                $(document).bind('keydown' + eventClassName, function (e) {
                    console.log('ps-keydown');
      ...
      /* TODO niszczenie, update bezpo�rednio z metody *-update, usun�� niepotrzebne rzecz? zmieni� nazw� */
